...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        tb_mr = new QPushButton(centralwidget);
        tb_mr->setObjectName("tb_mr");
        tb_mr->setMinimumSize(QSize(0, 0));
        tb_mr->setFont(font1);

        gridLayout->addWidget(tb_mr, 2, 2, 1, 1);
...
#endif // QT_CONFIG(shortcut)
        tb_mr->setText(QCoreApplication::translate("MainWindow", "MR", nullptr));
